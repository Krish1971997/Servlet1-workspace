...
public class AdminGroupServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (idStr != null) {
            ...
            for (Post p : posts) p.setComments(commentDAO.getComments(p.getId(), true));
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        if (back == null) back = req.getContextPath() + "/admin/groups";
        ...
        switch (action == null ? "" : action) {
            ...
            case "post": {
                ...
                if (postId > 0 && userIdsRaw != null && !userIdsRaw.isBlank()) {
                    ...
                    if (!ids.isEmpty()) postDAO.sharePost(postId, ids);
                }
                break;
            }
        }

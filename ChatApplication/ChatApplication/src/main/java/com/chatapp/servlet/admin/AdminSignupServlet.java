...
public class AdminSignupServlet extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp)
        ...
        String err = userDAO.register(username, email, password, "admin");
        if (err != null) { error(req, resp, err); return; }

        req.setAttribute("success", "Admin account created! Please log in.");
